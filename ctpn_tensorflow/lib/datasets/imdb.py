...
class imdb(object):
    ...
    def __init__(self, name):
        self._name = name                     # 图片数据库名称
        self._num_classes = 0                 # 图片类别数
        self._classes = []                    # 图片类别列表
        self._image_index = []                # 图片名称列表
        self._obj_proposer = 'selective_search'
        self._roidb = None
        print("the default_roidb is :",self.default_roidb)
    ...
    def _get_widths(self):                 # 返回整张图片的宽度
